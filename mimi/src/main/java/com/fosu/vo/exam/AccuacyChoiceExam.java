...
@ApiModel(description="章节Choice正确率 ",value="AccuacyChoiceExam")
public class AccuacyChoiceExam {

	@ApiModelProperty(value="选择ID")
	...
	public String toString() {
		return "AccuacyExam [choice_id=" + choice_id + ", que_index_id=" + que_index_id + ", question_subject="
				+ question_subject + ", question_chapter=" + question_chapter + ", question_section=" + question_section
				+ ", question_chapName=" + question_chapName + ", question_secName=" + question_secName + ", accuacy="
				+ accuacy + "]";
	}
